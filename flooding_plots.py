...
def plot_min_max_boxplot(min_queues, max_queues, filename='flooding_minmax_boxplot.png'):
...
def plot_max_distribution(max_queues, filename='flooding_max_distribution.png'):
    plt.figure(figsize=(12, 6))
...
def main():
    max_queues = np.load("data/max_queues.npy")
    min_queues = np.load("data/min_queues.npy")
